...
cmp.setup({
  ...
  sources = cmp.config.sources({
    ...
    { name = "nvim_lsp_signature_help", priority = 900, keyword_length = 3 },
    { name = "luasnip", priority = 750, keyword_length = 3 },
    { name = "buffer", priority = 500, keyword_length = 3 },
    { name = "path", priority = 250, keyword_length = 3 },
    { name = "git", priority = 700, keyword_length = 3 },
    { name = "conventionalcommits", priority = 600, keyword_length = 3 },
